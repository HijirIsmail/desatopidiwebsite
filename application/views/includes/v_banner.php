    ...
    <div id="carouselExampleSlidesOnly" class="carousel slide" data-ride="carousel">
      <div class="carousel-inner">
        <div class="carousel-item active">
          <div class="carousel-caption d-md-block" style="margin-bottom: 300px;">
            <h1 style="
  -webkit-text-stroke-width: 1px;
  -webkit-text-stroke-color: white;">Welcome to Desa Topidi</h1>
            <h2>Topidi adalah sebuah desa di wilayah Kelurahan Bonto Lerung, <br>Kecamatan Tinggimoncong, Kabupaten Gowa, Provinsi Sulawesi Selatan.</h2>
          ...
          <img class="img-slide" style="width:100vw; height:100vh; opacity:1;" src="<?=base_url()?>assets/img/topidibanner1.jpg" alt="First slide">
        </div>
