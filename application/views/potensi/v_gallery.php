...
-->
        ...
        <link rel="stylesheet" href="<?=base_url()?>assets/galleryassets/css/bootstrap.min.css">
        <link rel="stylesheet" href="<?=base_url()?>assets/galleryassets/css/bootstrap-theme.min.css">
        <link rel="stylesheet" href="<?=base_url()?>assets/galleryassets/css/fontAwesome.css">
        <link rel="stylesheet" href="<?=base_url()?>assets/galleryassets/css/hero-slider.css">
        <link rel="stylesheet" href="<?=base_url()?>assets/galleryassets/css/tooplate-style.css">

        <link href="https://fonts.googleapis.com/css?family=Open+Sans:300,400,600,700,800" rel="stylesheet">

        <script src="<?=base_url()?>assets/galleryassets/js/vendor/modernizr-2.8.3-respond-1.4.2.min.js"></script>
    </head>
...
<body>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="right-image">
                        <img src="<?=base_url()?>assets/galleryassets/img/what-we-do-right-image.png" alt="">
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="projects-holder">
                        <div class="row">
                            <div class="col-md-3 col-sm-6 project-item mix workspace">
                              <div class="thumb">
                                  <div class="image">
                                    <img src="<?=base_url()?>assets/galleryassets/img/portfolio_01.jpg">
                                  </div>
                                  <div class="hover-effect">
                                    <a href="<?=base_url()?>assets/galleryassets/img/portfolio_big_01.jpg" data-lightbox="image-1"><i class="fa fa-search"></i></a>
                                  </div>
                              </div>
                            </div>
                            <div class="col-md-3 col-sm-6 project-item mix workspace">
                              <div class="thumb">
                                  <div class="image">
                                    <img src="<?=base_url()?>assets/galleryassets/img/portfolio_02.jpg">
                                  </div>
                                  <div class="hover-effect">
                                    <a href="<?=base_url()?>assets/galleryassets/img/portfolio_big_02.jpg" data-lightbox="image-1"><i class="fa fa-search"></i></a>
                                  </div>
                              </div>
                            </div>
                            <div class="col-md-3 col-sm-6 project-item mix technology">
                              <div class="thumb">
                                  <div class="image">
                                    <img src="<?=base_url()?>assets/galleryassets/img/portfolio_03.jpg">
                                  </div>
                                  <div class="hover-effect">
                                    <a href="<?=base_url()?>assets/galleryassets/img/portfolio_big_03.jpg" data-lightbox="image-1"><i class="fa fa-search"></i></a>
                                  </div>
                              </div>
                            </div>
                            <div class="col-md-3 col-sm-6 project-item mix city">
                              <div class="thumb">
                                  <div class="image">
                                    <img src="<?=base_url()?>assets/galleryassets/img/portfolio_04.jpg">
                                  </div>
                                  <div class="hover-effect">
                                    <a href="<?=base_url()?>assets/galleryassets/img/portfolio_big_04.jpg" data-lightbox="image-1"><i class="fa fa-search"></i></a>
                                  </div>
                              </div>
                            </div>
                            <div class="col-md-3 col-sm-6 project-item mix nature">
                              <div class="thumb">
                                  <div class="image">
                                    <img src="<?=base_url()?>assets/galleryassets/img/portfolio_05.jpg">
                                  </div>
                                  <div class="hover-effect">
                                    <a href="<?=base_url()?>assets/galleryassets/img/portfolio_big_05.jpg" data-lightbox="image-1"><i class="fa fa-search"></i></a>
                                  </div>
                              </div>
                            </div>
                            <div class="col-md-3 col-sm-6 project-item mix technology">
                              <div class="thumb">
                                  <div class="image">
                                    <img src="<?=base_url()?>assets/galleryassets/img/portfolio_06.jpg">
                                  </div>
                                  <div class="hover-effect">
                                    <a href="<?=base_url()?>assets/galleryassets/img/portfolio_big_06.jpg" data-lightbox="image-1"><i class="fa fa-search"></i></a>
                                  </div>
                              </div>
                            </div>
                            <div class="col-md-3 col-sm-6 project-item mix workspace">
                              <div class="thumb">
                                  <div class="image">
                                    <img src="<?=base_url()?>assets/galleryassets/img/portfolio_07.jpg">
                                  </div>
                                  <div class="hover-effect">
                                    <a href="<?=base_url()?>assets/galleryassets/img/portfolio_big_07.jpg" data-lightbox="image-1"><i class="fa fa-search"></i></a>
                                  </div>
                              </div>
                            </div>
                            <div class="col-md-3 col-sm-6 project-item mix city">
                              <div class="thumb">
                                  <div class="image">
                                    <img src="<?=base_url()?>assets/galleryassets/img/portfolio_08.jpg">
                                  </div>
                                  <div class="hover-effect">
                                    <a href="<?=base_url()?>assets/galleryassets/img/portfolio_big_08.jpg" data-lightbox="image-1"><i class="fa fa-search"></i></a>
                                  </div>
                              </div>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="blog-item b1">
                        <div class="thumb">
                            <img src="<?=base_url()?>assets/galleryassets/img/blog_01.jpg" alt="">
                ...
                <div class="col-md-6">
                    <div class="blog-item second-blog b2">
                        <div class="thumb">
                            <img src="<?=base_url()?>assets/galleryassets/img/blog_02.jpg" alt="">
                            <div class="text-content">
                ...
                <div class="col-md-6">
                    <div class="blog-item b3">
                        <div class="thumb">
                            <img src="<?=base_url()?>assets/galleryassets/img/blog_03.jpg" alt="">
                            <div class="text-content">
    ...
    <div id="contact" class="page-section">
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="map">
                        <img src="<?=base_url()?>assets/galleryassets/img/map.jpg" alt="">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="row">
    ...
    <script>window.jQuery || document.write('<script src="<?=base_url()?>assets/galleryassets/js/vendor/jquery-1.11.2.min.js"><\/script>')</script>

    <script src="<?=base_url()?>assets/galleryassets/js/vendor/bootstrap.min.js"></script>

    <script src="<?=base_url()?>assets/galleryassets/js/plugins.js"></script>
    <script src="<?=base_url()?>assets/galleryassets/js/main.js"></script>
